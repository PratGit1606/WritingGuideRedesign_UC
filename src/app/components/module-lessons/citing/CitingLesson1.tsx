...
export default function CitingLesson1() {
  return (
    <>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 items-center px-2 md:px-8 py-10 max-w-6xl mx-auto gap-8">
        <div className="space-y-6">
          <h1 className="text-3xl font-bold leading-snug">
            ...
            <span className="underline decoration-asu-gold font-extrabold">Let’s turn research into Ready-to-Submit writing!</span>
          </h1>
        ...
        <div className="flex justify-center md:justify-end">
          <Image src="/EditingFrontGraphic.png" alt="Citing illustration" width={420} height={420} className="max-w-full h-auto" />
        </div>
      </section>
      ...
      <LessonFooter
        prev={{
          kind: "section",
          id: "editing-5",
          label: "Go Back to Previous Section: Editing",
        }}
        next={{
          kind: "section",
          id: "citing-2",
          label: "Continue to Section 1 of Citing",
        }}
      />
    </>
  );
