...
export default function CitingLesson3() {
  return (
    <>
        ...
        overviewContent={
          <div className="py-4">
            ...
            <p className="text-[18px] text-black leading-relaxed mb-4">
              Citation style guides provide rules for quoting and paraphrasing material, formatting your paper, creating a list of sources
              used, and more. It is important to properly cite all of the sources you have used in a paper. This practice conveys your
              credibility, gives credit to other researchers and their ideas, allows your readers to find the sources you used, and helps you
              avoid plagiarism.
            </p>

            <p className="text-[16px] text-gray-800 mb-4">
              Citing your sources also allows you to engage in a scholarly community and contribute your perspective and knowledge to that
              community. To avoid plagiarism, make sure you give credit to a source if you present an idea, definition, statistic,
              recommendation, etc., that is not your original thought.
            </p>
            ...
            <p className="text-[16px] text-gray-800 mb-4">
              Create a tracking system where you collect all of your references and mark when you have used that source in your paper.
              Consider using:
            </p>
            ...
            <p className="text-[16px] text-gray-800 mb-6">
              While researching for your paper, create an annotated bibliography as you go. An annotated bibliography is a list of sources
              that have a short summary or annotation about each source. It can also serve as a checklist that you can use to see which
              sources you have included in your paper and will need to properly cite.
            </p>
                ...
                <div className="min-w-full">
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
                      <div>
                        <div className="md:hidden text-gray-700 font-medium mb-2">
                          What information would be helpful when tracking your sources?
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
                      <div>
                        <div className="md:hidden text-gray-700 font-medium mb-2">
                          What system could allow you to collect this information?
                        </div>
                        <div className="text-gray-800">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
                      <div>
                        <div className="md:hidden text-gray-700 font-medium mb-2">
                          Is this system something you can maintain through your writing process?
                        </div>
                        <div className="text-gray-800">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
                      <div>
                        <div className="md:hidden text-gray-700 font-medium mb-2">
                          When in your writing process do you plan to update your sources?
                        </div>
                        <div className="text-gray-800">
                      ...
                      <div>
                        <label htmlFor="q4" className="sr-only">
                          Your notes
                        </label>
                        <textarea
                          id="q4"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
                      <div>
                        <div className="md:hidden text-gray-700 font-medium mb-2">
                          When in your writing process do you plan to check your citations for correctness?
                        </div>
                        <div className="text-gray-800">
                      ...
                      <div>
                        <label htmlFor="q5" className="sr-only">
                          Your notes
                        </label>
                        <textarea
                          id="q5"
      ...
      <LessonFooter
        prev={{
          kind: "section",
          id: "citing-2",
          label: "Go Back to Section 1 of Citing",
        }}
        next={{
          kind: "section",
          id: "citing-4",
          label: "Continue to Section 3 of Citing",
        }}
      />
    </>
  );
