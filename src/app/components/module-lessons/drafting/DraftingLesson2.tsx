...
export default function DraftingLesson2() {
    ...
    <>
        ...
        overviewContent={
          <div className="py-4">
            ...
            <p className="text-[16px] text-gray-800 leading-relaxed mb-4">
              Writing a thesis statement requires you to consider what your assignment description is asking you to take a stance on and
              how you plan to present that stance by presenting your argument. By reviewing your ideas and the research you have read so
              far, you can begin to craft your own argument and thesis statement. Your thesis should include the scope of your topic, how
              you will present your argument, and why it is significant to your audience.
            </p>

            <p className="text-[16px] text-gray-800 mb-4">
              Below, we share strategies for drafting a thesis and give you a chance to practice. When drafting a thesis statement, consider
              your brainstorming and research so far and determine what you want to argue and how you want to convince your audience of
              your stance.
            </p>
            ...
            <div className="mb-4">
              ...
              <p className="text-gray-800 mb-2">
                List words or phrases related to your particular topic. Using multiple lists can help you see other authors’ perspectives
                and help you gather and organize your ideas. Create lists based on:
              </p>
            ...
            <div className="mb-4">
              ...
              <p className="text-gray-800 mb-2">
                Write whatever comes to mind about the topic you are addressing with your thesis statement. You can write a paragraph, a
                list, ask questions, or draft an outline — there is no structure to a free write.
              </p>
              <ul className="list-disc list-inside text-gray-800 ml-4 space-y-1">
                <li>
                  Don’t worry about spelling or grammar, and write about why you feel stuck if you don’t know what to write about. These
                  thoughts may form ideas or questions for your thesis.
                </li>
              </ul>
            </div>
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-800 mb-2">
                Sit down and talk to a peer, professor, or writing tutor. Talking about your ideas will help you organize your thoughts on
                your argument. Share things such as:
              </p>
              <ul className="list-disc list-inside text-gray-800 ml-4 space-y-1">
              ...
              <p className="text-gray-800 mt-3">
                Once you get your initial thoughts out, you will then be able to refine your thesis into an arguable statement that can
      ...
      <LessonFooter
        prev={{
          kind: "section",
          id: "drafting-1",
          label: "Go Back to Intro of Drafting",
        }}
        next={{
          kind: "section",
          id: "drafting-3",
          label: "Continue to Section 2 of Drafting",
        }}
      />
    </>
  );
