...
export default function DraftingLesson3() {
    ...
    <>
        ...
        overviewContent={
          <div className="py-4">
            ...
            <p className="text-[16px] text-gray-800 leading-relaxed mb-4">
              After drafting your thesis statement, continue to refine your ideas and create an outline for your assignment. From your
              outline you can visualize how to present your thesis to your audience and integrate evidence into your writing to support it.
              Integrating evidence is essential in academic writing because it shows authority, presents a position or critique, refers to
              work that supports your own, and adds depth to your writing.
            </p>
            ...
            <div className="mb-6">
                  ...
                  <tbody>
                    <tr>
                      <td className="border px-4 py-3 align-top">
                        <strong>A summary</strong> is a condensed and objective restatement, in your own words, of an author’s core message
                        or argument.
                      </td>
                      <td className="border px-4 py-3 align-top">
                    ...
                    <tr>
                      <td className="border px-4 py-3 align-top">
                        <strong>Synthesis</strong> is breaking sources into differing or similar parts and assembling them in a new way to
                        create something original.
                      </td>
                      <td className="border px-4 py-3 align-top">
                        <strong>Synthesis</strong> combines multiple voices from current research with your perspective to create a new
                        argument.
                      </td>
                    </tr>
                  </tbody>
              ...
              <div className="md:hidden space-y-3">
                <div className="border rounded p-3">
                  ...
                  <p>
                    <strong>A summary</strong> is a condensed and objective restatement, in your own words, of an author’s core message or
                    argument.
                  </p>
                </div>
                <div className="border rounded p-3">
            ...
            <ul className="list-disc list-inside text-gray-800 mb-6">
              <li>
                <strong>Direct Quotation:</strong> Quoting a sentence or phrase exactly as it appears when the words are vivid or
                significant and have an impact on the reader.
              </li>
              <li>
                <strong>Paraphrasing:</strong> Your rendition of essential information and ideas expressed by someone else, presented in a
                new form.
              </li>
            </ul>

            <p className="text-[16px] text-gray-800 mb-6">
              Below are strategies for drafting an outline that helps you organize, summarize and synthesize your evidence. Consider how you
              want to organize the evidence you have collected so far.
            </p>

            <h3 className="text-lg font-semibold mb-3">Build an Outline from your Assignment Description</h3>
            <p className="text-gray-800 mb-4">Take your assignment description and use it as a starting outline:</p>
            <ul className="list-disc list-inside text-gray-800 mb-4">
              <li>Break up each point that the assignment description wants you to address.</li>
              <li>
                Summarize the evidence you have so far that can answer those points — this may be a paragraph, list, collection of quotes,
                or other research notes.
              </li>
            ...
            <div className="border rounded p-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="assignmentDesc" className="block text-sm font-semibold mb-2">
                ...
                <div>
                  <label htmlFor="outlineNotes" className="block text-sm font-semibold mb-2">
                    Outline / Evidence notes
                  </label>
                  <textarea
                    id="outlineNotes"
                    value={outlineNotes}
      ...
      <LessonFooter
        prev={{
          kind: "section",
          id: "drafting-2",
          label: "Go Back to Section 1 of Drafting",
        }}
        next={{
          kind: "section",
          id: "drafting-4",
          label: "Continue to Section 3 of Drafting",
        }}
      />
    </>
  );
