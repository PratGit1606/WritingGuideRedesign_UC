...
export default function DraftingLesson5() {
    ...
    <>
      ...
      <div className="space-y-8 py-8">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mt-4 font-semibold text-red-700">All set? Let&apos;s move on to Revision!</p>
        </div>
      </div>
      ...
      <LessonFooter
        prev={{
          kind: "section",
          id: "drafting-4",
          label: "Go Back to Section 3 of Drafting",
        }}
        next={{
          kind: "section",
          id: "revision-1",
          label: "Continue to Revision",
        }}
      />
    </>
  );
