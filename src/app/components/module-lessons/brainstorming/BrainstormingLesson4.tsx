...
export default function BrainstormingLesson4() {
  return (
    <>
        ...
        overviewContent={
          <div className="py-4">
            ...
            <p className="text-[18px] text-black leading-relaxed mb-6">
              Once you have your outline and thesis written, you can begin figuring out what you know and what you need to explore your
              topic further. By identifying what you know and don’t know, you will be able to start developing your research plan. In this
              section, we will discuss tools that you can use, such as questions to help you flesh out where you need additional
              information, considering your topic choice and paper requirements.
            </p>
            ...
            <div className="mt-6 mb-6">
              ...
              <p className="text-gray-700 mb-4">
                Use the form below to capture the information you still need. On small screens each question stacks into its own labeled
                input; on larger screens the layout looks and behaves like a compact table.
              </p>
              ...
              <form className="space-y-4">
                ...
                {[
                  ...
                  },
                  {
                    key: "needsMoreInfo",
                    label:
                      "Is there any part of my topic that I feel I need more information on to be ready to write about it?",
                  ...
                  <div key={row.key} className="grid grid-cols-1 md:grid-cols-3 gap-3 items-start md:items-center">
                ...
                <div className="flex justify-end gap-3 mt-2">
                  <button type="reset" className="px-4 py-2 border rounded-md bg-white text-gray-800 hover:bg-gray-100">
                    Clear
                  </button>
                  <button
                    type="button"
      ...
      <LessonFooter
        prev={{
          kind: "section",
          id: "brainstorming-3",
          label: "Go Back to Section 2 of Brainstorming",
        }}
        next={{
          kind: "section",
          id: "brainstorming-5",
          label: "Continue to Outro of Brainstorming",
        }}
      />
    </>
  );
