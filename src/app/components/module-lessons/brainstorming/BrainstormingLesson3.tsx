...
export default function BrainstormingLesson3() {
  return (
    <>
        ...
        overviewContent={
          <div className="py-4">
            ...
            <p className="text-[18px] text-black leading-relaxed mb-4">
              Once you have a preliminary thesis or research question in mind, you can start planning the direction your argument will take.
              When outlining or mind-mapping, you can connect main ideas, evaluate what sources you will need, and assess what you do and
              don’t know.
            </p>

            <p className="text-[16px] text-gray-800 mb-6">
              Below, we share strategies for how to both outline and mind-map your way through an assignment and give you space to practice.
              Use information from the analyzing step to begin brainstorming your thoughts either physically (paper and pencil) or
              electronically (Word or Google Docs).
            </p>
            ...
            <div className="border rounded-xl p-4 bg-gray-50 mb-6">
              ...
              <p className="text-gray-700">
                Here’s an idea: use{" "}
                <a href="https://miro.com" className="text-blue-600 underline">
                  Miro
                </a>{" "}
                as a visual workspace where you can map your ideas and draw connections.
              </p>
            </div>
            ...
            <p className="text-[16px] text-gray-800">
              It’s okay if your first outline or mind map is messy — brainstorming is not always a tidy process. As your ideas shift, remake
              your outline and map to make them clearer.
            </p>
          </div>
        }
      />
      <LessonFooter
        prev={{
          kind: "section",
          id: "brainstorming-2",
          label: "Go Back to Section 1 of Brainstorming",
        }}
        next={{
          kind: "section",
          id: "brainstorming-4",
          label: "Continue to Section 3 of Brainstorming",
        }}
      />
    </>
  );
