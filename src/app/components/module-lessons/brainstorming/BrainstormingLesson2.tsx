...
export default function BrainstormingLesson2() {
  return (
    <>
        ...
        overviewContent={
          <div className="py-4">
            ...
            <p className="text-[18px] text-black leading-relaxed mb-4">
              Developing your thesis is the most important step in the writing process because it helps contextualize for the reader what
              you are going to discuss in a clear statement. In this section, we will discuss strategies you can use to develop a strong
              thesis statement.
            </p>

            <p className="text-[18px] text-black leading-relaxed mb-4">
              When you write a thesis statement — whether it is for an analytical, explanatory, or persuasive essay — you are making
              connections between the overarching topic and the main ideas that you will explore.
            </p>
            ...
            <p className="text-[16px] text-gray-800 mb-6">
              Once you outline these items, you can begin to weave together a complete sentence that connects the prompt, the main topic,
              and the questions you are exploring.
            </p>
            ...
            <div className="mt-6 mb-6">
              ...
              <p className="text-[16px] text-gray-800 mb-3">Write a 700-word persuasive essay about your favorite restaurant.</p>
              ...
              <p className="text-[16px] text-gray-800 mb-4">
                Fazoli’s is the best Italian fast-food restaurant in the Phoenix Valley because of its ideal location, fresh flavor, and the
                welcoming atmosphere that creates memorable family moments.
              </p>

              <p className="text-[16px] text-gray-800 mb-6">
                This thesis takes the main idea of “what is your favorite restaurant?” and lays out why, based on location, flavor,
                atmosphere, and memories, the restaurant is the best. These become the main ideas you can develop in the body of your paper.
              </p>
            </div>
            ...
            <div className="border rounded-xl p-4 bg-gray-50">
              ...
              <p className="text-gray-700">
                Here’s an idea: use{" "}
                <a href="https://www.grammarly.com" className="text-blue-600 underline">
                  Grammarly
                </a>{" "}
                to help brainstorm topic ideas and create a potential outline for your work.
              </p>
            </div>
          </div>
        }
      ...
      <LessonFooter
        prev={{
          kind: "section",
          id: "brainstorming-1",
          label: "Go Back to Brainstorming Intro",
        }}
        next={{
          kind: "section",
          id: "brainstorming-3",
          label: "Continue to Section 2 of Brainstorming",
        }}
      />
    </>
  );
