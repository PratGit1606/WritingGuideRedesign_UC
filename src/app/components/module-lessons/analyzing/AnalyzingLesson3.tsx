...
export default function AnalyzingLesson3() {
  return (
    <>
        ...
        overviewContent={
          <div className="py-4">
            ...
            <p className="text-[18px] text-black leading-relaxed mb-6">
              ...
              <span className="font-bold">understand what the needs of your audience are.</span> Whether they are reading your paper, using your website, or
              listening to your presentation, you want to consider what their needs, expectations, and knowledge levels are. Keeping this in mind will help
              you ensure that your message will come across.
            </p>

            <div className="flex justify-center my-8">
              <Image src="/AnalysingDoc2.png" alt="Writing Situation Triangle" width={400} height={300} className="max-w-xs md:max-w-sm lg:max-w-md" />
            </div>

            <p className="text-[18px] text-black leading-relaxed mb-6">
              Think of each writing situation as a triangle. As you write, you always need to keep a{" "}
              <span className="font-bold">
                balance between the choices you make as a writer, the needs of your audience, and the overall purpose you have for your writing.
              </span>
            </p>
            ...
            <div className="grid gap-6 mt-6">
              {[
                ...
                <div key={i} className="border border-gray-300 rounded-xl p-6 bg-white shadow-sm">
                  ...
                  {item.hint && <p className="text-sm text-gray-500 italic mb-2">{item.hint}</p>}
      ...
      <LessonFooter
        ...
        next={{
          kind: "section",
          id: "analyzing-4",
          label: "Continue to Section 3 of Analysing",
        }}
      />
    </>
  );
