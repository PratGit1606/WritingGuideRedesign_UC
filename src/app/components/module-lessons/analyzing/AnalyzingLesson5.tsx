...
export default function AnalyzingLesson5() {
    ...
    <>
      ...
      <div className="space-y-8">
        <div className="bg-amber-50 border border-amber-200 rounded-xl text-center py-4 px-6 shadow-sm">
          ...
          <p className="text-gray-800">Your analysing game is officially on point – keep slaying those sentences</p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8">
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left flex-shrink-0">
            ...
            <Image src="/notebook.png" alt="Notebook Checklist" width={224} height={224} className="w-40 sm:w-48 lg:w-56 h-auto" />
          </div>
      ...
      <div className="space-y-8 py-8">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-800">
            <li>Understand the genre and expectations of your assignment</li>
            <li>Understand who it is I am trying to speak to</li>
            <li>Understand how my assignment will be graded and important metrics to consider when writing.</li>
          </ol>
          <p className="mt-4 font-semibold text-red-700">All set? Let&apos;s move on to Brainstorming!</p>
        </div>
      </div>
      ...
      <LessonFooter
        ...
        next={{
          kind: "section",
          id: "brainstorming-1",
          label: "Continue to Brainstorming",
        }}
      />
    </>
  );
