...
export default function ResearchingLesson5() {
    ...
    <>
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="bg-amber-50 border border-amber-200 rounded-xl text-center py-4 px-6 shadow-sm">
          ...
          <p className="text-gray-800 mt-2">
            You’re tracking your research well — review the checklist and tune your skill confidence.
          </p>
        </div>
      ...
      <div className="space-y-8 py-8">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mt-4 font-semibold text-red-700">
            All set? Let&apos;s move on to Drafting!
          </p>
        </div>
      </div>
      ...
      <LessonFooter
        prev={{
          kind: "section",
          id: "researching-4",
          label: "Go Back to Section 3 of Researching",
        }}
        next={{
          kind: "section",
          id: "drafting-1",
