...
export default function RevisionLesson2() {
  return (
    <>
        ...
        overviewContent={
          <div className="py-4">
            ...
            <p className="text-[16px] text-gray-800 leading-relaxed mb-4">
              To revise literally means to “re-examine” or to “take another look at.” Revising your writing involves refining the content
              and the meaning of your writing, making sure your main ideas are clearly expressed.
            </p>
            ...
            <div className="border rounded-xl p-4 bg-gray-50 mb-4">
              ...
              <p className="mt-2">
                Does each paragraph build on the previous one? Do your paragraphs support and clearly connect back to your thesis or main
                point?
              </p>
            </div>
            ...
            <ul className="list-disc list-inside text-gray-800 mb-4 space-y-2">
              ...
              <li>
                Giving your mind time and space to think about other things will help you gain critical distance. Come back to your writing
                with a rested mind and a fresh perspective.
              </li>
              <li>
                <strong>Don&apos;t delete:</strong> Create a new document where you can cut and paste sentences or paragraphs that you feel
                don&apos;t fit or rework and reorder sentences and paragraphs in that new document.
              </li>
              <li>
                Revising does not mean you have to start deleting parts of your draft entirely. You may find you need those ideas later!
              </li>
            </ul>

            <h3 className="text-lg font-semibold mb-2">Try a Reverse Outline:</h3>
            <p className="text-[16px] text-gray-800 mb-4">
              An especially effective strategy for revision is making a reverse outline of your draft. Reverse outlining can help you
              determine:
            </p>
            ...
            <div className="border rounded p-4 mb-6 bg-white">
              ...
              <p className="text-gray-800">
                ...
                <a
                  ...
                  className="underline text-[#0a58ca]"
                >
                  Grammarly
                </a>{" "}
                to help you brainstorm topic ideas and create a potential outline for your work.
              </p>
            </div>
            ...
            <ol className="list-decimal list-inside text-gray-800 space-y-3 mb-6">
              <li>Create a new document or blank piece of paper and write your thesis statement at the top.</li>
              <li>
                Summarize each of your paragraphs in one sentence (or write out the topic sentence of each paragraph). Note where it might
      ...
      <LessonFooter
        prev={{
          kind: "section",
          id: "revision-1",
          label: "Go Back to Intro of Revision",
        }}
        next={{
          kind: "section",
          id: "revision-3",
          label: "Continue to Section 2 of Revision",
        }}
      />
    </>
  );
