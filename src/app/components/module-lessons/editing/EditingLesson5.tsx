...
export default function EditingLesson5() {
  ...
  const items = [
    ...
    {
      id: 3,
      title: "I only have capital letters where I start a sentence or use a proper noun.",
    },
    {
      id: 4,
      title: 'Search for every usage of the word “like” and remove any that are used casually.',
    },
  ];
    ...
    <>
      ...
      <div className="space-y-8">
        <div className="bg-amber-50 border border-amber-200 rounded-xl text-center py-4 px-6 shadow-sm">
          ...
          <p className="text-gray-800">Your editing game is officially on point – keep slaying those sentences</p>
        </div>
          ...
          <div className="flex-1 w-full space-y-4">
            {items.map((item) => (
              <button
                ...
                className={`w-full flex items-start gap-3 p-4 border rounded-lg shadow-sm text-left transition ${
                  completed.includes(item.id) ? "bg-green-100 border-green-400" : "bg-white hover:bg-gray-50"
                }`}
              >
                <div
      ...
      <div className="space-y-8 py-8">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-800">
            <li>Read your paper aloud, feeling confident in the meaning and word choice in each sentence.</li>
            <li>Find and correct errors that may interfere with your audience&apos;s understanding of your work.</li>
            <li>Consider your audience and purpose for writing and adapt your word choice appropriately.</li>
          </ol>
          <p className="mt-4 font-semibold text-red-700">All set? Let&apos;s move on to Citing!</p>
        </div>
      </div>
      ...
      <LessonFooter
        prev={{
          kind: "section",
          id: "editing-4",
          label: "Go Back to Section 3 of Editing",
        }}
        next={{
          kind: "section",
          id: "citing-1",
          label: "Continue to Citation",
        }}
      />
    </>
  );
