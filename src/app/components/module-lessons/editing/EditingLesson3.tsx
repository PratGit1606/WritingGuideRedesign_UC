...
export default function EditingLesson3() {
  return (
    <>
      ...
      <TabWithChecklist
        ...
        overviewContent={
          <div className="py-4">
            ...
            <h2 className="text-[30px] font-bold mb-2">Looking at the flow between my sentences and paragraphs</h2>
            <div className="py-4">
              <p className="text-[18px] text-black leading-relaxed">
                The feeling of <span className="italic">“flow”</span> in writing comes from the shape of our sentences and paragraphs, the
                way key ideas are organized within the sentence or the paragraph (Willams &amp; Bizup, 2017).
              </p>
              <p className="text-[18px] text-black leading-relaxed mt-4">
                When the end of one sentence sets up the start of the next sentence, the reader feels like your writing is cohesive. This is
                a <span className="font-bold">good rule of thumb for sentence flow</span>, and it can also work for paragraphs. Below are
                some strategies to help you edit the flow of your writing.
              </p>
            </div>

            <div className="mb-6">
              <h3 className="text-[18px] font-bold mb-2 bg-asu-gold inline-block px-2">Repeat key terms in your transitions</h3>
            ...
            <div className="mb-6">
              <h3 className="text-[18px] font-bold mb-2 bg-asu-gold inline-block px-2">Use transitional words correctly</h3>
              <p className="text-[18px] text-gray-800 leading-relaxed">
                Transitional words like <span className="font-semibold">“additionally,” “however,” “alternatively,”</span> etc. help your
                reader understand the relationship between your sentences, paragraphs, and larger ideas.{" "}
            ...
            <div className="mb-6">
              <h3 className="text-[18px] font-bold mb-2 bg-asu-gold inline-block px-2">Crafting Cohesive Sentences:</h3>
              <p className="text-[18px] text-gray-800 leading-relaxed">
                Cohesive sentences flow from one to another by starting with old or familiar information and ending with new or less
                familiar information. <br />
                Let us point out something important here - we emphasize this practice under editing, not drafting. It will be difficult to
                write our thoughts down if you spend too much time thinking about sentence cohesion in the drafting stage.
              </p>
            </div>
            ...
            <div className="mt-6">
              ...
              <p className="text-[18px] text-gray-800 leading-relaxed mt-4">
                What is familiar and what cannot be anticipated will change for each paper and each audience, but as the author, you can
                critically consider your readers and then determine what topics they are or aren’t exposed to.
              </p>
            </div>
          </div>
        }
      ...
      <LessonFooter
        prev={{
          kind: "section",
          id: "editing-2",
          label: "Go Back to Section 1 of Editing",
        }}
        next={{
          kind: "section",
          id: "editing-4",
          label: "Continue to Section 3 of Editing",
        }}
      />
    </>
  );
