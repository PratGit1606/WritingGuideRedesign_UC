    ...
    <div className="relative min-h-screen font-sans text-gray-800 bg-[url(/background.jpeg)] bg-cover bg-center">
      <div className="flex w-full mx-auto px-6 md:px-10 mt-12 gap-8">
        <div className="w-80 sticky top-24 self-start">
          <Sidebar currentSection="citing" currentStep="verifying" />
        </div>
            ...
            overviewContent={
              <div className="py-4">
                ...
                <p className="text-[16px] text-gray-800 mb-4">
                  In addition to formatting, citation style guides also have rules on how to create footnotes,
                  in-text citations, and references. Varying disciplines write for different purposes and different
                  audiences, and researchers in different disciplines cite different types of resources. Citation
                  style allows writers to share their knowledge with their audience in a consistent manner alongside
                  other researchers. Verifying that your formatting, citations, references, and footnotes all follow
                  the citation style guide is important because it shows how you are participating in the academic
                  community your writing is a part of.
                </p>

                <h3 className="text-lg font-semibold mt-4 mb-2">Footnotes</h3>
                <p className="text-[16px] text-gray-800 mb-3">
                  You will need to use footnotes when you want to add more commentary on a point, provide another
                  citation, or any other additional information while not disrupting the flow of your writing. Be
                  sure to double-check your style guide. Some citation styles, like Chicago, use footnotes for citations.
                </p>

                <h3 className="text-lg font-semibold mt-4 mb-2">In-text citations</h3>
                <p className="text-[16px] text-gray-800 mb-3">
                  You will need to use in-text citations when you are directly quoting, paraphrasing, or summarizing
                  information from a source. Be sure to double-check your style guide. Some citation styles, like
                  Chicago, don’t often use in-text citations.
                </p>

                <h3 className="text-lg font-semibold mt-4 mb-2">References</h3>
                <p className="text-[16px] text-gray-800 mb-4">
                  You will need to use references within your paper to list all of the sources you have cited in your
                  paper. Below are some tips on how to verify that your citations and formatting are following the
                ...
                <div className="mt-4 md:mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 text-[15px] text-gray-800">
                      <li>Most citation style guides have a printed or digital manual you can reference to check the proper in-text and reference guidelines.</li>
                      <li>Online resources such as Purdue OWL, Scribbr, or OWL Excelsior also have information on in-text citations and references.</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 text-[15px] text-gray-800">
                      <li>Ask your peers, colleagues, or professor questions about in-text citations, references, footnotes, or other parts of a citation style guide.</li>
